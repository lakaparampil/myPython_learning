...
def ltp_option_selection(event):
    global class_x,class_count_list,df1
...
def tt_val_sub_code_update():
    global df3,in_tt,my_data_tt,new_ltp,code_dict,class_count_dict 
    ...
    match class_x:
        ...
        case "Tutorial":
            ...
            for i in range(len(new_ref)):
                ...
                if class_count_dict[temp_val] <= 26:
                    T_count = 1
                elif class_count_dict[temp_val] <= 48:
                    T_count = 2
                else:
                    T_count = 3
            hr_count = T_count
